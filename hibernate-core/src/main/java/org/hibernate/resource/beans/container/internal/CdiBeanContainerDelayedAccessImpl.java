...
public class CdiBeanContainerDelayedAccessImpl extends AbstractCdiBeanContainer {
	...
	protected <B> ContainedBeanImplementor<B> createBean(
		...
		return new DelayedBeanImpl<>( beanType, lifecycleStrategy, fallbackProducer, this, false );
	}
	...
	protected <B> ContainedBeanImplementor<B> createBean(
			...
			BeanLifecycleStrategy lifecycleStrategy,
			BeanInstanceProducer fallbackProducer) {
		return new NamedDelayedBeanImpl<>( name, beanType, lifecycleStrategy, fallbackProducer, this, false );
	}
}

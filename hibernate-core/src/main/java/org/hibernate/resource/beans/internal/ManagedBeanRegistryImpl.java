...
import org.hibernate.resource.beans.container.internal.NamedDelayedBeanImpl;
...
public class ManagedBeanRegistryImpl implements ManagedBeanRegistry, BeanContainer.LifecycleOptions, Stoppable {
	...
	@Override
	public <T> ManagedBean<? extends T> getBootstrapSafeBean(String beanName, Class<T> beanContract) {
		if ( isContainerBootstrapSafe() ) {
